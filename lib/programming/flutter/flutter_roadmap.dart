...
class _FlutterRoadMapState extends State<FlutterRoadMap> {
  ...
  final String urlPath =
      'https://firebasestorage.googleapis.com/v0/b/final-smart-learn.appspot.com/o/Smart_Learn%2FProgramming%2FFlutter%2Fflutter_roadmap.pdf?alt=media&token=9bc82542-6f34-4077-b180-36c4a5484c63';
  ...
  Future<void> downloadPdf() async {
    ...
    FlutterDownloader.registerCallback((id, status, progress) {
      if (taskId == id && status == DownloadTaskStatus.complete) {
        setState(() {
          localPath = '/storage/emulated/0/Download/flutter_roadmap.pdf';
        });
      }
    });
  }
          ...
          Padding(
            ...
            child: IconButton(
              onPressed: () async {
                ...
                String fullPath = "$path/flutter_roadmap.pdf";
