...
class GoResource12 extends StatefulWidget {
  const GoResource12({super.key});

  @override
  State<GoResource12> createState() => _GoResource12State();
}

class _GoResource12State extends State<GoResource12> {
